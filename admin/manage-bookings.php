				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Bookings</h2>
						...
						<tbody>
<?php $sql = "SELECT Booking.BookingId as bookid,Users.FullName as fname,Users.MobileNumber as mnumber,Users.EmailId as email,Packages.PackageName as pckname,Booking.PackageId as pid,Booking.FromDate as fdate,Booking.ToDate as tdate,Booking.Comment as comment,Booking.status as status,Booking.CancelledBy as cancelby,Booking.UpdationDate as upddate from Users join  Booking on  Booking.UserEmail=Users.EmailId join Packages on Packages.PackageId=Booking.PackageId";
$query = $dbh -> prepare($sql);
$query->execute();
